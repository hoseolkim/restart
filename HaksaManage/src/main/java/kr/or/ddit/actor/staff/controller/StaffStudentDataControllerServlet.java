...
public class StaffStudentDataControllerServlet extends HttpServlet {
	...
	private final String STUDENT_IMG_FOLDER = "/resources/img/student";
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(req instanceof StandardMultipartHttpServletRequest) {
			MultipartFile file = ((StandardMultipartHttpServletRequest) req).getFile("stdImage");
			...
			if(valid) {
				...
				case OK:
					...
					viewName = "redirect:/staff/studentList";
					break;								
				default:
